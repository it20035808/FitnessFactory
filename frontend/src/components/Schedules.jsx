...
retrieveSchedules(){
  axios.get("http://localhost:8070/schedules/schedules").then(res =>{
    if(res.data.success){
      this.setState({
...
onDelete = (id) =>{
  axios.delete(`http://localhost:8070/schedules/schedule/delete/${id}`).then((res) =>{
          ...
          <div className="d-flex justify-content-center align-items-center h-100">
            ...
            <table className="table table-hover " style={{marginTop:'40px'}}>
              ...
              <tbody>
                ...
                <tr key={index}>
                  <td> 
                      <a href={`/scheduleDetails/${schedules._id}`} style={{textDecoration:'none'}}>
                  ...
                  <td> 
                    <center> 
                      <a className="btn btn-warning" href={`/editSchedule/${schedules._id}`}>
            ...
            <button className="btn btn-success"> <a href="/createSchedule" style={{textDecoration:'none' , color:'white'}}> <i class="fas fa-plus-square"></i> &nbsp; Create New Schedule </a></button>
