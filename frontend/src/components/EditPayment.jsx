...
onChangeAmount(e){
    ...
    onSubmit=(e)=>{ 
        ...
        axios.put(`http://localhost:8070/payment/payment/update/${id}`,data).then((res)=>{
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:8070/payment/payment/'+ this.props.match.params.id).then(response=>{
                this.setState({
