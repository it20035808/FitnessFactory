...
export default class CreatePayment extends Component{
   ...
   onSubmit=(e)=>{
        ...
        axios.put(`http://localhost:8070/expenses/expense/update/${id}`,data).then((res)=>{
   ...
   componentDidMount(){
    ...
    axios.get('http://localhost:8070/expenses/expense/'+ this.props.match.params.id).then(response=>{
                this.setState({
