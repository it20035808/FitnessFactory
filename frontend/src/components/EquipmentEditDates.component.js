...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    componentDidMount() {
        axios.get('http://localhost:8070/equipment/' + this.props.match.params.id)
            .then(response => {
                this.setState({
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:8070/equipment/update/' + this.props.match.params.id, equipment)
