...
retrievePosts(){
    axios.get("http://localhost:8070/events/posts").then(res =>{
        if(res.data.success){
            this.setState({
...
onDelete = (id) =>{
    ...
    axios.delete(`http://localhost:8070/events/post/delete/${id}`).then((res) =>{
        ...
        return (
            <div>
                ...
                <div style={{ backgroundImage: `url(${workout1})`,  backgroundPosition:'center', backgroundSize:'cover' , width:'100%', height:'600px'}}>
                        ...
                        <tbody>
                            {this.state.posts.map((posts,index) =>(
                                <tr key={index}>
                                    ...
                                    <td>
                                        <Link to={`/postDetails/${posts._id}`} style={{textDecoration:'none'}}>
                                    ...
                                    <td>
                                        <Link className="btn btn-warning" to={`/editEvents/${posts._id}`}>
                    ...
                    <button className="btn btn-success"><Link to="/createEvents" style={{textDecoration:'none',color:'white'}}>Create New Event</Link></button>
