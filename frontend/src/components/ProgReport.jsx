...
retrieveProgreports(){
  axios.get("http://localhost:8070/progreport/progreports").then(res =>{
    if(res.data.success){
      this.setState({
...
onDelete = (id) =>{
  axios.delete(`http://localhost:8070/progreport/progreport/delete/${id}`).then((res) =>{
        ...
        <div class="mask" style={{backgroundColor: "rgba(251, 251, 251, 0.6)"}}>
          <div class="d-flex justify-content-center align-items-center h-100">
            ...
            <div className="container">
              ...
              <button className="btn btn-success"> <a href="/createProgReport" style={{textDecoration:'none' , color:'white'}}> <i class="fas fa-plus-square"></i> &nbsp;  Create Progress Report </a></button>
